...
//		FileSystem fs = FileSystem.get(conf );
    ...
    public void testCopyFromLocalFile() throws IOException, InterruptedException, URISyntaxException{
        ...
        // 2 执行上传API
        fs.copyFromLocalFile(new Path("/home/hq/TISHQ/input/wc.txt"), new Path("/hadoop1"));
...
//		fs.copyToLocalFile(new Path("/banhua.txt"), new Path("e:/banhua.txt"));
        fs.copyToLocalFile(false, new Path("/hadoop/wc.text"), new Path("/home/hq/TISHQ/output"), true);
